  ...
  <div class="connect">
    <el-breadcrumb separator="/">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item class="currentTitle" v-if="isEditType == 1"
          >修改</el-breadcrumb-item
        >
    ...
    <el-card>
      <!-- <span class="iconfont icon-fanhui back" @click="back"> 返回</span> -->
      <el-button
        type="info"
        plain
        icon="el-icon-back"
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      var postUrl = "dealer/firstDept/add";
      if (this.isEditType == 1) {
        postUrl = "dealer/firstDept/update";
        postData = {
          id: this.editId,
          name: this.addForm.name,
          deptName: this.addForm.deptName,
